...
const SCREENS: { path: string; open?: string }[] = [
  ...
  { path: '/sales/quotations', open: '견적 등록' },
  { path: '/sales/orders' },
  { path: '/sales/sales-documents', open: '매출전표 등록' },
  { path: '/sales/purchase-documents', open: '매입전표 등록' },
  { path: '/sales/purchase-requests', open: '구매요청 등록' },
  { path: '/sales/purchase-orders' },
  { path: '/sales/returns' },
  { path: '/settlement/receipts', open: '수금 등록' },
  { path: '/settlement/payments', open: '지급 등록' },
  { path: '/settlement/receivables' },
  { path: '/settlement/payables' },
  { path: '/approval/inbox' },
  { path: '/hr/employees' },
  { path: '/reports/sales' },
  { path: '/reports/items' },
